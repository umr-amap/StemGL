...
%     qat,qpt,qict,qft,qmt,qdict,qlit,qdat,qlat,qdft,qlft,qdmt,qlmt,MesO,MesS,MesT,...
...
%
%  Fitting Greenlab procedure
%
%   I    modH:              int    Use hydraulic model 
%   I    Lsqr:              int    Use Least Square mpethod
%   I    .....
%   O    MesO(DMS):         double Observed measurements      
%   O    MesS(DMS):         double Simulated measurements      
%   O    MesT(DMS):         double Measurements typology (org number + 10 if phytomer)  
%   O    DMS:               int    Number of measurments       
%   O    ....
%
%   Last version 2019/05/21. Main author PdR/MJ. Copyright Cirad-AMAP
%
function [Dt,Qt,TQt,TQAt,TQPt,TQICt,TQFt,TQMt,TQRt,TQTt,Ba,Bp,Bi,Bc,Bf,Bm,Bt,...
...
%         end
        prevpar = 1;
        for par = 1 : deriv % Loop for the derivative of least square method,pass-----pass
            ...
            [WM,WPD,x,Dt,Qt,TQt,TQAt,TQPt,TQICt,TQFt,TQMt,TQRt,TQTt,Ba,Bp,Bi,Bc,Bf,Bm,Bt,...
               ...
               if (x-DMS)*(x-DMS) > 0
                   fprintf (1,'\n Error on number of measures. Expected:%d  Computed:%d\n',DMS,x);
               end
