...
function [] = Draw_Organ(Leaf_Display,Internode_Display,Fruit_Display,...
        ...
        if Fruit_Display == 1
            if nf > 0 && qdfs*qlfs > 0
                for j =1:nf
                    ...
                    %% MJ correction 2018 05 11 One line replaced
                    rectangle('position',[pos_x-x_orig,pos_y+ypos,qlfs,qdfs],'Curvature',[0.7,0.7],'FaceColor',Col_FFruit);
                end
            end
            if nm >0 && qdms*qlms > 0
                for j =1:nm
